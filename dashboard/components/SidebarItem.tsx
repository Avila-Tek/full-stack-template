...
function SidebarItem({
  ...
  if (!isCollapsible) {
    return (
      <li className="items-center px-6 border-transparent hover:bg-cool-gray-200 border-r-4 hover:border-cool-gray-500">
  ...
  return (
    <>
      ...
      <li className="items-center px-6">
        <ul
          className={`${
            isOpen ? 'flex' : 'hidden'
        ...
        >
          {subLinks.map((link) => (
            <li
              className="items-center border-transparent hover:bg-cool-gray-200 border-r-4 hover:border-cool-gray-500"
              key={link.as}
            >
